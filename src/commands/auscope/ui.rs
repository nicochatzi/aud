...
pub const API: &str = include_str!("../../../api/auscope/api.lua");
pub const DOCS: &str = include_str!("../../../api/auscope/docs.lua");
...
impl Ui {
    ...
    pub fn render(&mut self, f: &mut Frame<impl Backend>, app: &mut super::app::App) {
