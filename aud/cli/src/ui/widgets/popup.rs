...
lazy_static::lazy_static! {
    static ref PS: parsing::SyntaxSet = parsing::SyntaxSet::load_defaults_newlines();
    static ref TS: highlighting::ThemeSet = highlighting::ThemeSet::load_defaults();
    static ref THEME: &'static highlighting::Theme = &TS.themes["base16-ocean.dark"];
